...
def util_tiny_imagenet.build_tiny_imagenet_dataset(is_train, args):
    """
...
def process(pn, args):
    ...
    if args.dataset == "tiny_imagenet":
        trainset = util_tiny_imagenet.build_tiny_imagenet_dataset(is_train=True, args=args)
        testset  = util_tiny_imagenet.build_tiny_imagenet_dataset(is_train=False, args=args)
    else:
